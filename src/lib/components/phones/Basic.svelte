<script lang="ts">
	import HouseThiefImg from '$lib/assets/img/housethief.png?enhanced';
	import Title from './Title.svelte';
	import Text from './Text.svelte';
	import Image from './Image.svelte';

	const title: string = 'Prosečan telefon';
...
<div class="my-4 pt-4 sm:pt-6 md:pt-12 lg:pt-20">
	...
	>
		<Image src={HouseThiefImg} alt="House thief" loading="lazy" />
